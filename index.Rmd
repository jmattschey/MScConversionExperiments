--- 
title: "MSc Psychology (Conversion) - Experiment Library"
...
```{r Figure0-2, out.width = '95%', fig.align = 'center', echo = FALSE, fig.cap = 'Click the download button to start downloading the experiment.'}

knitr::include_graphics('images/opensesame/download.png')
```
