...
```{r Figure5-3, out.width = '25%', fig.align = 'center', echo = FALSE, fig.cap = 'Example of the object pairs included in the short task version, as shown in the file pool in Open Sesame.'}
...
Ganis, G., & Kievit, R. (2015). A new set of three-dimensional shapes for investigating mental rotation processes: validation data and stimulus set. *Journal of Open Psychology Data, 3*, e3: Retrieved from: https://openpsychologydata.metajnl.com/articles/10.5334/jopd.ai/
