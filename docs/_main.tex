...
\hypertarget{executive-functions}{%
\chapter{Executive Functions}\label{executive-functions}}

\hypertarget{working-memory-tasks}{%
\section{Working Memory Tasks}\label{working-memory-tasks}}

\hypertarget{digit-span-task}{%
\subsection{Digit Span Task}\label{digit-span-task}}
...
\subsection{Attentional Network Task (ANT)}\label{attentional-network-task-ant}}
...
\subsection{Simon Task}\label{simon-task}}
...
\subsection{Stroop Task}\label{stroop-task}}
...
\hypertarget{visual-attention}{%
\chapter{Visual Attention}\label{visual-attention}}
...
\hypertarget{miscellaneous-tasks}{%
\chapter{Miscellaneous Tasks}\label{miscellaneous-tasks}}

\hypertarget{spatial-awareness}{%
\section{Spatial Awareness}\label{spatial-awareness}}

\hypertarget{mental-rotation}{%
\subsection{Mental Rotation}\label{mental-rotation}}
...
{\centering \includegraphics[width=0.25\linewidth]{images/RotationNumberList} 
...
\hypertarget{social-attitudes}{%
\section{Social Attitudes}\label{social-attitudes}}
