...
To do this, you can download the file posted to the Open Sesame forum [here](https://forum.cogsci.nl/discussion/5876/) and copy it into your experiment file. If you want to combine Qualtrics and Open Sesame, this also allows us to link both by asking participants to enter their participant ID.
